...
import qa.util.WebDriverEventListenerImpl;
...
public class BaseTest {
	...
	@BeforeMethod
	public void setup() {
		// setUp will run before each @Test method
		...
		// USE WebDriverManager to automatically setup driver for the browser
		WebDriverManager.getInstance(DriverManagerType.valueOf(browser)).setup();

		// lauch appropiate browser
		switch (browser) {
		case "CHROME":
		...
		// the WebDriverEventListenerImpl class is an implementation class of Selenium's
